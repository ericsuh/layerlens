...
|---|---|---|---|---|
| 001 | Toolchain & walking skeleton | Technical design › Frontend (esbuild, `go:embed`); Testing, validation, toolchain (mise tools+tasks, golangci-lint, tsc, test runners) | — | Not started |
